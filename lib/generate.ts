...
export const VERIFIER_INSTRUCTIONS = [
  ...
  '',
  'ONLY WHAT THE SUMMARY ITSELF STATES counts as evidence. Not what you know',
  'about the product, not what a tool of this kind usually does, not what its',
  'name suggests, and not what would be reasonable to assume. If you find',
  'yourself completing the summary from memory, the answer is false.',
  '',
